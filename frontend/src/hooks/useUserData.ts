...
export function useUserData(tokenAddress?: string): { vaultBalance: bigint; nativeBalance: bigint; tokenBalance: bigint; tokenSymbol: string; allowance: bigint; refetch: () => void } {
